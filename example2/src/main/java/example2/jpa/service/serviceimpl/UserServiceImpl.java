...
//                .orElseThrow(() -> new RuntimeException("Source account not found with number: " + fromAccountNumber));
//        Account toAccount = accountRepository.findByAccountNumber(toAccountNumber)
//                .orElseThrow(() -> new RuntimeException("Destination account not found with number: " + toAccountNumber));
//
//        if (fromAccount.getBalance().compareTo(amount) < 0) {
//            throw new RuntimeException("Insufficient balance in source account number: " + fromAccountNumber);
//        }
//
...
//    @Override
//    public void transferFundsWithContactNumber(Long fromContactNumber, Long toContactNumber, BigDecimal amount) {
//        if (amount.compareTo(BigDecimal.ZERO) <= 0) {
//            throw new IllegalArgumentException("Transfer amount must be positive.");
//        }
//        Optional<Account> fromAccountOptional = accountRepository.findByAccountNumber(fromContactNumber);
//        Optional<Account> toAccountOptional = accountRepository.findByAccountNumber(toContactNumber);
//        if (fromAccountOptional.isPresent() && toAccountOptional.isPresent()) {
//            Account fromAccount = fromAccountOptional.get();
//            Account toAccount = toAccountOptional.get();
//            if (fromAccount.getBalance().compareTo(amount) >= 0) {
...
//            System.out.println("This is api fethcing method and the following programes are do to take the rest of the period and the functionality are many types of working in the whole projecs and the working processis mainly working from the home. ");
//        } else {
//            throw new RuntimeException("Account not found");
//        }
//    }
